...
def logout_view(request):
    logout(request)
    return redirect('home')  # or any page you want to redirect to after logout
...
def customer_signup_view(request):
    ...
    if request.method == 'POST':
        ...
        if userForm.is_valid() and customerForm.is_valid():
            ...
            try:
                validate_password(user.password)  # 🔒 Validate password
...
def customer_address_view(request):
    ...
    if request.method == 'POST':
        ...
        if addressForm.is_valid():
            ...
            response.set_cookie('mobile',mobile, secure=True, httponly=True)
            response.set_cookie('address',address, secure=True, httponly=True)
            return response
